# Pre-Commit Code Review (Linus Style)

**Description:** Reviews git changes before commit with Linus Torvalds' legendary code review style - direct, uncompromising, and technically rigorous.

**When to use:** Run this before creating git commits to catch errors, performance issues, and bad code practices.
